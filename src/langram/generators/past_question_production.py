"""Free output for past-tense yes/no questions: ask it in Turkish, unprompted.

A thin wrapper around past_question.py's "type" mode, the same way
...
from . import past_question as _base

GENERATOR = "past_question_production"
